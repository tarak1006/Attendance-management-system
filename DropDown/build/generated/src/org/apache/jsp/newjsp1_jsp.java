...
//System.out.println(bd.doubleValue());
            ...
            Class.forName("com.mysql.jdbc.Driver");
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/ashok", "root", "ashok1234");
		...
		String insertTableSQL = "INSERT INTO COLLEGE"
				+ "(REGISTRATION_NO, NAME, SECTION, SOCIAL_CATEGORY, ADMISSION_CATEGORY, COURSE, BRANCH, SEMESTER, ACADEMIC_YEAR, REGULATION) VALUES"
				+ "(?,?,?,?,?,?,?,?,?,?)";
		...
		try {
			...
			preparedStatement.setString(9, values[i1][8]);
                        preparedStatement.setString(10, values[i1][9]);

			// execute insert SQL stetement
			preparedStatement.executeUpdate();
                        System.out.println(values[i1][0]+" "+values[i1][1]+" "+values[i1][2]+" "+values[i1][3]+" ");
